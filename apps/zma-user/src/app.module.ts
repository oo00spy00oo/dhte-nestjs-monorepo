...
import { TenantGrpcController, UserGrpcController } from './controllers/grpc';
import { HealthModule } from './controllers/health/health.module';
import { UserKafkaController } from './controllers/kafka';
import { TenantMutation, UserMutation } from './controllers/mutations';
import { TenantResolver, UserResolver } from './controllers/resolvers';
import { TenantSchema, UserSchema } from './frameworks/data-services/mongo/entities';
import { DataServicesModule } from './services/data-services/data-services.module';
import { TenantUseCaseModule } from './use-cases/tenant/tenant.use-case.module';
...
@Module({
      ...
      useFactory: (configService: AppConfigService) => {
        ...
        return {
          ...
          autoSchemaFile: isDevelopment
            ? join(process.cwd(), 'graphqls/zma-user/schema.gql')
            : true,
  ...
  controllers: [UserGrpcController, TenantGrpcController, UserKafkaController],
  providers: [
    {
      provide: APP_GUARD,
